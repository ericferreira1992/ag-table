    ...
    this.changeLogs = [
      {
        version: '1.22.0',
        descriptions: [
          'Migrated <strong>AgTable</strong> to Angular version 22.',
        ]
      },
      {
        version: '1.21.0',
        descriptions: [
          'Migrated <strong>AgTable</strong> to Angular version 21.',
        ]
      },
      {
        version: '1.20.0',
        descriptions: [
          'Migrated <strong>AgTable</strong> to Angular version 20.',
        ]
      },
      {
        version: '1.19.0',
        descriptions: [
          'Migrated <strong>AgTable</strong> to Angular version 19.',
        ]
      },
      {
        version: '1.5.0',
