...
export class AppComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private checkHeaderShadow() {
    ...
    this.shadowHeader = mainContainerEl && mainContainerEl.scrollTop > 68 || false;
  }
  ...
  private onMouseWheel(event: WheelEvent) {
    ...
    const scrollLength = mainContainerEl.scrollHeight - mainContainerEl.clientHeight;
